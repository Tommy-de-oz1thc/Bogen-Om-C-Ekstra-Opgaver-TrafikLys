...
namespace BackGammon
{
    public class SetBricks
    {
        ...
        public SetBricks() 
        {
            ...
            Settings.field0.ClearList();
            Settings.field1.ClearList();
            Settings.field1.AddListBricks(Settings.brick1);
            Settings.field1.AddListBricks(Settings.brick2);
            Settings.field2.ClearList();
            Settings.field3.ClearList();
            Settings.field4.ClearList();
            Settings.field5.ClearList();
            Settings.field5.AddListBricks(Settings.brick26);
            Settings.field5.AddListBricks(Settings.brick27);
            Settings.field5.AddListBricks(Settings.brick28);
            Settings.field6.ClearList();
            Settings.field7.ClearList();
            Settings.field7.AddListBricks(Settings.brick21);
            Settings.field7.AddListBricks(Settings.brick22);
            Settings.field7.AddListBricks(Settings.brick23);
            Settings.field7.AddListBricks(Settings.brick24);
            Settings.field7.AddListBricks(Settings.brick25);
            Settings.field8.ClearList();
            Settings.field9.ClearList();
            Settings.field10.ClearList();
            Settings.field11.ClearList();
            Settings.field12.ClearList();
            ...
            Settings.field13.ClearList();
            Settings.field13.AddListBricks(Settings.brick16);
            Settings.field13.AddListBricks(Settings.brick17);
            Settings.field13.AddListBricks(Settings.brick18);
            Settings.field13.AddListBricks(Settings.brick19);
            Settings.field13.AddListBricks(Settings.brick20);
            Settings.field14.ClearList();
            Settings.field15.ClearList();
            Settings.field16.ClearList();
            Settings.field17.ClearList();
            Settings.field17.AddListBricks(Settings.brick8);
            Settings.field17.AddListBricks(Settings.brick9);
            Settings.field17.AddListBricks(Settings.brick10);
            Settings.field18.ClearList();
            Settings.field19.ClearList();
            ...
            Settings.field20.ClearList();
            Settings.field21.ClearList();
            Settings.field22.ClearList();
            Settings.field23.ClearList();
            Settings.field24.ClearList();
            Settings.field24.AddListBricks(Settings.brick29);
            Settings.field24.AddListBricks(Settings.brick30);
            Settings.field25.ClearList();
            Settings.field26.ClearList();
            Settings.field27.ClearList();
        }
    }
}
